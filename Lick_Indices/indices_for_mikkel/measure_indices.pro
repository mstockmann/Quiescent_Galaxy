...
;; 5/9/2015: This one needs to be recomputed for the final reduction
;    ; read spectrum corrected for emission lines
;    file=DIR+'MACS2129.rebin16.1dopt.gaussprofile.galext.spec_decomp.fits'
;    data=mrdfits(file,1)
;    lambda_res=data.restwl
;    flux=data.stellar
;    error=data.noise
