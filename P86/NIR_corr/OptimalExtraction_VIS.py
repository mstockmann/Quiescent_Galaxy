...
N_spec = glob.glob('../../../X-shooter/cQGsample/Objects/CP*')

# Path_2d_spec = glob.glob('../../../X-shooter/P86_COSMOS_1/Data/CP*/Combined_OBs/NIR_corr/*_V1_NIR_corr.fits')

Path_2d_spec = glob.glob('../../../X-shooter/cQGsample/Objects/CP-*/VIS/*_sig5_V1_wmrebin3.fits')


# klim_list = [[27, 44],[27, 44],[27, 44],[27, 44]]
klim_list = [[47,57],[55, 60],[44,57],[43, 60]]
...
for ii in range(len(N_spec)):
    ...
    # _plot_trace_slope(Flux,Wave,binsize=10)
